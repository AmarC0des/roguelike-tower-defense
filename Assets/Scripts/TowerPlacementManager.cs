...
public class TowerPlacementManager: MonoBehaviour
{
    ...
    {
        return new Vector3(player.transform.position.x + placementDistance, player.transform.position.y, player.transform.position.z); // Place tower near the player at ground level
    }
